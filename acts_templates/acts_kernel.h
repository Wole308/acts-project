...
public:
	...
	// unsigned int top_function( HBM_channelAXI_t * HBM_EDGESA0, HBM_channelAXI_t * HBM_EDGESB0, HBM_channelAXI_t * HBM_EDGESA1, HBM_channelAXI_t * HBM_EDGESB1, HBM_channelAXI_t * HBM_EDGESA2, HBM_channelAXI_t * HBM_EDGESB2, HBM_channelAXI_t * HBM_EDGESA3, HBM_channelAXI_t * HBM_EDGESB3, HBM_channelAXI_t * HBM_EDGESA4, HBM_channelAXI_t * HBM_EDGESB4, HBM_channelAXI_t * HBM_centerA, HBM_channelAXI_t * HBM_centerB, 	
